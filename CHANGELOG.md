...
* All buttons that do not fit in height should be placed into More button: category buttons, as well
...
* Fix vulnerability which allows adding a third-party audio file to a document when converting PPT to PPTX (65056)
...
* Fix vulnerability which allows performing manipulations on the client machine when converting HTML to DOCX (63779)
